...
const Home = () => {
    // State quản lý thẻ nào đang được hover trong section "Dành cho ai" (Mặc định ô 0: Sinh viên)
    ...
    return (
        <div className="min-h-screen bg-[#FBF9F5] text-[#2C2825] font-sans antialiased selection:bg-[#E65100] selection:text-white">
            {/* Custom CSS Keyframes cho hiệu ứng nổi (Floating) */}
            <style>{`
            ...
            <header className="bg-[#FBF9F5]/90 backdrop-blur-md border-b border-[#E8E2D9] sticky top-0 z-50 transition-all duration-300">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3 group cursor-pointer">
                        <div className="w-10 h-10 bg-[#E65100] rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-md group-hover:scale-105 transition-transform">
                            <span className="border-2 border-white rounded-md w-5 h-5 flex items-center justify-center text-[10px]">✓</span>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            href="/login"
                            className="text-sm font-semibold text-[#2C2825] bg-[#F3EFEA] hover:bg-[#E8E2D9] px-5 py-2.5 rounded-xl transition-all duration-200 active:scale-95"
                        >
                            Đăng nhập
                        </a>
                        <a
                            href="/register"
                            className="text-sm font-semibold bg-[#E65100] hover:bg-[#D84315] text-white px-5 py-2.5 rounded-xl shadow-md hover:shadow-lg hover:shadow-orange-500/20 transition-all duration-200 active:scale-95"
                        >
                            Đăng ký miễn phí
                        </a>
                    </div>
            ...
            <section className="pt-16 pb-20 max-w-7xl mx-auto px-6 overflow-hidden">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-6 space-y-6">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#F5EBE1] text-[#E65100] text-xs font-semibold hover:bg-orange-100 transition-colors">
                        ...
                        <div className="flex flex-wrap items-center gap-4 pt-2">
                            <a
                                href="/register"
                                className="bg-[#E65100] hover:bg-[#D84315] text-white font-bold px-7 py-3.5 rounded-xl shadow-md hover:shadow-xl hover:shadow-orange-500/25 transition-all transform hover:-translate-y-0.5 active:scale-95"
                            >
                                Bắt đầu miễn phí
                            </a>
                            <a
                                href="/login"
                                className="bg-[#F3EFEA] hover:bg-[#E8E2D9] text-[#2C2825] font-bold px-7 py-3.5 rounded-xl transition-all border border-[#E8E2D9] active:scale-95"
                            >
                                Tôi đã có tài khoản
                            </a>
                        </div>
                        ...
                        <p className="text-xs text-[#9E958C]">
                            Miễn phí cho toàn bộ sinh viên và giảng viên trong khoa · Không cần thẻ thanh toán
                        </p>
                    </div>
                    ...
                    <div className="lg:col-span-6 relative flex justify-center items-center py-12">
                        ...
                        <div className="relative w-full max-w-125 perspective-1000">
                            {/* Floating Badge 1 */}
                            <div className="absolute -top-6 -left-4 z-20 bg-white/95 backdrop-blur-md px-4 py-2.5 rounded-2xl shadow-[0_12px_28px_rgba(0,0,0,0.08)] border border-slate-100 flex items-center gap-2.5 animate-float-badge-1 transition-transform hover:scale-105">
                                <div className="w-6 h-6 rounded-full bg-[#E8F5E9] flex items-center justify-center text-[#2E7D32] text-xs font-bold">
                                    ✓
                                </div>
                                <span className="text-xs font-bold text-[#2C2825] tracking-tight">
                                    Đã xác nhận lịch hẹn
                                </span>
                            </div>

                            {/* Main Card */}
                            <div className="bg-white/90 backdrop-blur-sm rounded-4xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-[#F0ECE6] animate-float-main space-y-7 relative z-10 hover:shadow-[0_25px_60px_rgba(0,0,0,0.09)] transition-shadow">
                                ...
                                <div className="flex items-center gap-6 pt-1">
                                    <div className="relative w-20 h-20 shrink-0 flex items-center justify-center">
                                        <div 
                                            className="w-full h-full rounded-full flex items-center justify-center transition-transform hover:scale-105 duration-300"
                                            style={{
                            ...
                            {/* Floating Badge 2 */}
                            <div className="absolute -bottom-6 -right-2 z-20 bg-white/95 backdrop-blur-md px-5 py-3 rounded-2xl shadow-[0_12px_28px_rgba(0,0,0,0.08)] border border-slate-100 flex items-center gap-3 animate-float-badge-2 transition-transform hover:scale-105">
                                <div className="w-7 h-7 rounded-lg bg-[#F5EBE1] flex items-center justify-center text-[#E65100] text-sm">
                                    📅
                                </div>
                                <span className="text-xs font-bold text-[#2C2825] tracking-tight">
                                    Còn 46 ngày đến bảo vệ
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-[#FBF9F5] p-6 rounded-2xl border border-[#E8E2D9] space-y-4 hover:-translate-y-1.5 hover:shadow-lg transition-all duration-300">
                            ...
                            <p className="text-[#6B635B] text-xs leading-relaxed">
                                Toàn bộ mốc đồ án — đề cương, kiểm tra tiến độ, bảo vệ — hiển thị trên một lộ trình duy nhất, biết ngay mình đang ở đâu.
                            </p>
                        </div>
                        ...
                        <div className="bg-[#FBF9F5] p-6 rounded-2xl border border-[#E8E2D9] space-y-4 hover:-translate-y-1.5 hover:shadow-lg transition-all duration-300">
                            ...
                            <p className="text-[#6B635B] text-xs leading-relaxed">
                                Xem khung giờ trống của giảng viên hướng dẫn và đặt lịch chỉ trong vài giây, không cần nhắn tin qua lại.
                            </p>
                        </div>
                        ...
                        <div className="bg-[#FBF9F5] p-6 rounded-2xl border border-[#E8E2D9] space-y-4 hover:-translate-y-1.5 hover:shadow-lg transition-all duration-300">
                            ...
                            <p className="text-[#6B635B] text-xs leading-relaxed">
                                Cập nhật nhiệm vụ, nộp tài liệu và xem tiến độ tổng thể theo thời gian thực, không cần chờ báo cáo cuối kỳ.
                            </p>
                        </div>
                        ...
                        <div className="bg-[#FBF9F5] p-6 rounded-2xl border border-[#E8E2D9] space-y-4 hover:-translate-y-1.5 hover:shadow-lg transition-all duration-300">
                            ...
                            <p className="text-[#6B635B] text-xs leading-relaxed">
                                Trưởng bộ môn xem được toàn bộ lịch hẹn trong khoa trên một lịch chung, phát hiện lịch trùng sớm.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section id="cach-hoat-dong" className="py-20 max-w-7xl mx-auto px-6">
                ...
                <div className="bg-[#F3EFEA] p-8 sm:p-12 rounded-3xl border border-[#E8E2D9] grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="space-y-3">
                        ...
                        <p className="text-[#6B635B] text-xs leading-relaxed">
                            Đăng ký bằng email trường theo vai trò sinh viên hoặc giảng viên hướng dẫn.
                        </p>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-[#6B635B] text-xs leading-relaxed">
                            Chọn khung giờ trống và gửi yêu cầu hẹn, giảng viên xác nhận chỉ với một cú chạm.
                        </p>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-[#6B635B] text-xs leading-relaxed">
                            Cập nhật nhiệm vụ theo từng giai đoạn và nộp tài liệu ngay trên hệ thống.
                        </p>
                    </div>
                </div>
            </section>

            {/* 5. Target Roles Section (ĐÃ CẬP NHẬT HIỆU ỨNG HOVER LIA CHUỘT) */}
                ...
                <div className="bg-[#E65100] text-white p-8 sm:p-12 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl shadow-orange-600/30">
                    <div className="space-y-3 text-center md:text-left">
                        <h2 className="text-2xl sm:text-3xl font-black">
                            Sẵn sàng cho đồ án tốt nghiệp của bạn?
                        </h2>
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto justify-center">
                        <a
                            href="/register"
                            className="bg-white text-[#2C2825] font-bold px-6 py-3 rounded-xl text-xs sm:text-sm hover:bg-gray-100 transition shadow-sm active:scale-95"
                        >
                            Bắt đầu miễn phí
                        </a>
                        <a
                            href="/login"
                            className="bg-transparent border border-white/40 text-white font-bold px-6 py-3 rounded-xl text-xs sm:text-sm hover:bg-white/10 transition active:scale-95"
                        >
                            Đăng nhập
                        </a>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
                    <div className="md:col-span-6 space-y-3">
                        <div className="flex items-center gap-2">
                            <div className="w-6 h-6 bg-[#E65100] rounded-md flex items-center justify-center text-white font-bold text-xs">
                                ✓
                            </div>
